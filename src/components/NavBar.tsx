    ...
    <header className="px-32 py-8 z-10 lg:px-16 sm:px-8 md:px-12 font-medium flex justify-between items-center relative">
      ...
      {isOpen && (
        <motion.div
          ...
          className="min-w-[70vw] space-y-2 bg-dark/90 dark:bg-light/75 rounder-lg backdrop-blur-md py-32 z-30  flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        >
